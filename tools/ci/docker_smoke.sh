...
# Substitute: knights-archers, coworld-knights-archers, 4.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-knights-archers:ci)
#   SMOKE_SLUG                 game slug                        (knights-archers)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/knights-archers)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/knights-archers-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-knights-archers:ci}}"
slug="${SMOKE_SLUG:-knights-archers}"
