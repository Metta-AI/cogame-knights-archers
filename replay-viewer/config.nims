...
# use-after-free fixed in kaz_replay.nim (emscripten_exit_with_live_runtime)
...
# kaz_error_len(). Aborting keeps linear memory intact, and the page reads
# kaz_stage_ptr/len afterwards to report what the runtime was doing.
switch(
  "passL",
  (&"""
  -o {distDir / "kaz_replay.js"}
  ...
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_kaz_load_replay,_kaz_frame,_kaz_input,_kaz_packet_ptr,_kaz_packet_len,_kaz_mismatch_tick,_kaz_error_ptr,_kaz_error_len,_kaz_stage_ptr,_kaz_stage_len
  """).replace("\n", " ")
)
